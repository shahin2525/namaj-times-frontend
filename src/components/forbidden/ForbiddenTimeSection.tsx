...
//       desc = `${city} এর জন্য আজকের নিষিদ্ধ নামাজের সময় — সূর্যোদয়, জওয়াল ও সূর্যাস্ত।`;
//     } else {
//       title = `Forbidden Namaz Times in ${city} Today`;
//       desc = `Today's forbidden Namaz times in ${city}, including sunrise, zawal, and sunset.`;
//     }
